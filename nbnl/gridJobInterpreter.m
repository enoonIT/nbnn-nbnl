...
%   Detailed explanation goes here
    test_datasets = {'all_32_3_extra_hybrid_mean_dense', 'all_64_2_extra_hybrid_mean_dense', 'all_16_3_extra_hybrid_mean_dense'};
    algM = 10;
    jobD = ceil(jobId/5);
    input_folder = strcat(data_folder, '/desc/sport8/',test_datasets{jobD}, '/splits/');
