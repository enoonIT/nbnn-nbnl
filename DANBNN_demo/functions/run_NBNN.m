...
function [accuracyIN]=run_NBNN(target)
...
for c=uy     %for each class 
    ...
    feat_tr=cell2mat(tr'); % loads them into a single matrix (descriptorSize x nPatches)
